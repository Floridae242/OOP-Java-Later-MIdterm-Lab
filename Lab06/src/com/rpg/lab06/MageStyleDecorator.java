...
public class MageStyleDecorator extends AttackDecorator {
    ...
    public void attack(Character attacker, Destructible target) {
        ...
        if (mage.getMana() < MAGIC_MISSILE_COST) {
            ...
            System.out.println("   Current Mana: " + mage.getMana() + "/" + mage.getMaxMana() + " (Need: "
                    + MAGIC_MISSILE_COST + ")");
            return;
        }
        ...
        System.out.println("   Spell Bonus: +10 | Mana Used: " + MAGIC_MISSILE_COST + " | Remaining: " + mage.getMana()
                + "/" + mage.getMaxMana());
